...
class TestAMLDG(AMLDG):
    ...
    """
    def __init__(self, *args, train_phase=False, name='TestAMLDG', **kwargs):
        super().__init__(*args, train_phase=train_phase, name=name, **kwargs)
...
class TrainAMLDG(AMLDG):
    ...
    """
    def __init__(self, *args, train_phase=True, name='TrainAMLDG', **kwargs):
        super().__init__(*args, train_phase=train_phase, name=name, **kwargs)