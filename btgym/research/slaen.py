...
class SLAENPolicy(BaseAacPolicy):
    """
    Stacked LSTM with auxillary AutoEncoder loss support and Noisy-net layers policy,
    ...
    def __init__(self,
        ...
        self.on_state_decoded = on_decoded_layers[-1]
        # VAE KL-divergence output:
        self.on_vae_d_kl = on_d_kl
        ...
        self.off_state_decoded = off_decoded_layers[-1]
        # VAE KL-divergence output:
        self.off_vae_d_kl = off_d_kl
        ...
        try:
            ...
            with tf.device(self.worker_device):
                with tf.variable_scope('local'):
                    ...
                    self.loss = self.loss + on_vae_loss
